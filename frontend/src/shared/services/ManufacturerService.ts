...
import type { CreateManufacturerData, UpdateManufacturerData } from '../types/MedicationCrud';
 ...
 */
export const createManufacturer = async (data: CreateManufacturerData): Promise<Manufacturer> => {
 ...
 */
export const findManufacturerById = async (id: string): Promise<Manufacturer | null> => {
  const db = getManufacturerDB();
 ...
 */
export const findManufacturerByName = async (name: string): Promise<Manufacturer | null> => {
  const db = getManufacturerDB();
 ...
 */
export const updateManufacturer = async (id: string, data: UpdateManufacturerData): Promise<Manufacturer> => {
  const db = getManufacturerDB();
 ...
 * Buscar fabricantes
 */
export const searchManufacturers = async (query: string): Promise<Manufacturer[]> => {
  const db = getManufacturerDB();
