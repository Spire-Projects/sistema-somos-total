...
import type { CreatePharmaceuticalFormData, UpdatePharmaceuticalFormData } from '../types/MedicationCrud';
 ...
 */
export const createPharmaceuticalForm = async (data: CreatePharmaceuticalFormData): Promise<PharmaceuticalFormDoc> => {
  ...
  if (existing) {
    throw new Error(`Pharmaceutical form with name "${data.name}" already exists`);
  }
 ...
 */
export const findPharmaceuticalFormById = async (id: string): Promise<PharmaceuticalFormDoc | null> => {
  const db = getPharmaceuticalFormDB();
 ...
 */
export const findAllPharmaceuticalForms = async (): Promise<PharmaceuticalFormDoc[]> => {
  const db = getPharmaceuticalFormDB();
 ...
 */
export const findPharmaceuticalFormByName = async (name: string): Promise<PharmaceuticalFormDoc | null> => {
  const db = getPharmaceuticalFormDB();
 ...
 */
export const updatePharmaceuticalForm = async (id: string, data: UpdatePharmaceuticalFormData): Promise<PharmaceuticalFormDoc> => {
  const db = getPharmaceuticalFormDB();
 ...
 */
export const deletePharmaceuticalForm = async (id: string): Promise<boolean> => {
  const db = getPharmaceuticalFormDB();
 ...
 */
export const searchPharmaceuticalForms = async (query: string): Promise<PharmaceuticalFormDoc[]> => {
  const db = getPharmaceuticalFormDB();
