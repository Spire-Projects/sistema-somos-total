        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="w-20 text-center border-r border-gray-200">Descuento <br /> Unidad</TableHead>
              <TableHead className="w-20 text-center border-r border-gray-200">Precio Venta <br /> Unidad</TableHead>
